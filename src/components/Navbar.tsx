...
export function Navbar() {
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-border bg-purple-700">
      <div className="flex h-14 items-center px-4">
        ...
        <Link to="/" className="flex items-center gap-2 font-semibold">
          ...
          <span className="text-sm">RedTeamCN</span>
        </Link>
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <div className="hidden items-center gap-1 md:flex">
            <Bouton variant="ghost" size="icon" className="h-8 w-8">
          ...
          {/* Search Button */}
          <Bouton variant="outline" className="hidden h-8 gap-2 px-3 text-sm md:inline-flex bg-transparent">
          ...
          {/* Mobile Menu Button */}
          <Bouton variant="ghost" size="icon" className="h-8 w-8 md:hidden">
